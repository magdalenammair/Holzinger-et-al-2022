...
#png("Plots/plot_weight.png", width = 25, height = 12, units = "cm", res = 500)
tiff("Plots/plot_weight.tiff", height = 12, width = 25, units = "cm", res = 500)
...
arrows(-1.5, mean(weight_agg$mean[weight_agg$week == 0]), 16, mean(weight_agg$mean[weight_agg$week == 0]),
       angle = 0, lwd = 1.3, col = "grey70", lty = 2)
